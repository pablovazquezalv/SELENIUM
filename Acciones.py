...
class Acciones:
    ...
    def hacerClick(self,driver, wait, action, site_name):
        try:
    ...
    def extraerDatos(self,driver, wait, action, site_name):
        try:
            time.sleep(5)
            ...
            self.guardarArchivo(extracted_data, site_name)
        except Exception as e:
            print(f"Error extracting data in {site_name}: {e}")

    def extraerTabla(self,driver, wait, action, site_name):
        try:
            time.sleep(5)
    ...
    def hacerScroll(driver, wait, action, site_name):
        try:
    ...
    def escribir(driver, wait, action, site_name):
        try:
    ...
    def esperar(driver, wait, action, site_name):
        try:
    ...
    def guardarArchivo(data, description):
        try:
